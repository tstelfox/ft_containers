...
/*   Updated: 2022/02/13 20:42:56 by tmullan       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	iterators_test() {
	...
	std::cout << "\n<<<------AHHHHHH ITERATORS STUFF----->>>" << std::endl;
	ft::vector<int> hats;
	for (int i = 0; i < 72; i++)
		hats.push_back(i * 10);
	...
	std::cout << "regular iterator comparisons and inc/dec:" << std::endl;
	...
	// *cit += 10;
	// *crit += 10;
	std::cout << "reverse iterator comparisons and inc/dec:" << std::endl;
