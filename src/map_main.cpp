...
/*   Updated: 2022/02/13 20:38:00 by tmullan       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	iterators() {
	ft::map<int, std::string>	Turlough;

	Turlough.insert(ft::pair<int, std::string>(10, "Fuoco"));
	Turlough.insert(ft::pair<int, std::string>(12, "Kali"));
	Turlough.insert(ft::pair<int, std::string>(17, "Uchis"));
	Turlough.insert(ft::pair<int, std::string>(6, "Colombia"));
	Turlough.insert(ft::pair<int, std::string>(15, "Gran Colombia"));
	Turlough.insert(ft::pair<int, std::string>(4, "Shakira Shakira"));

	// testing if the container is empty
	if (Turlough.begin() == Turlough.end())
		std::cout << "begin is the same as end" << std::endl;
	else std::cout << "begin is NOTTTT the same as end" << std::endl;

	ft::map<int, std::string>::iterator					it = Turlough.begin();
	ft::map<int, std::string>::reverse_iterator			rit = Turlough.rbegin();
